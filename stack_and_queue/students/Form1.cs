...
namespace students
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                label1.Text = student_stack.Pop(); // Извлекает позицию из стека и возвращает ее в label
            }
            else if (radioButton2.Checked && student_queue.Count > 0)
            {
                label1.Text = student_queue.Dequeue(); // Извлекает позицию из очереди и возвращает ее в label
            }
